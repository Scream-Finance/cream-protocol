...
async function preMint(cToken, minter, mintAmount, mintTokens, exchangeRate) {
  ...
  await send(cToken.underlying, "approve", [cToken._address, mintAmount], {
    from: minter,
  });
...
async function redeemCTokensNative(
  cToken,
  redeemer,
  redeemTokens,
  redeemAmount
...
async function redeemUnderlyingNative(
  ...
  return send(cToken, "redeemUnderlyingNative", [redeemAmount], {
    from: redeemer,
  });
}
